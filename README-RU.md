...
| `UseAutoSaveInterval` | При включенном AutoSave определяет, сохранять ли через регулярные интервалы вместо каждого изменения | `false` |
| `AutoSaveInterval` | Количество операций между автоматическими сохранениями при включенных AutoSave и UseAutoSaveInterval | `3` |
